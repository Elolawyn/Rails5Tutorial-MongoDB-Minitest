...
class MicropostsInterfaceTest < ActionDispatch::IntegrationTest
  ...
  def setup
    ...
    @malory = User.create(name: "Malory Archer", email: "boss@example.gov", password: 'password', password_confirmation: 'password', activated: true, activated_at: Time.zone.now)
  ...
  test "micropost interface" do
    ...
    assert_difference '@user.reload.microposts.count', 1 do
